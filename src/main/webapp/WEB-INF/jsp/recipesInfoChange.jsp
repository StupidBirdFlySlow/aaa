...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    <!-- 内容主体区域 -->
     <div class="layui-card-header">菜谱信息修改</div>
  ...
  table.on('tool(demo)', function(obj){
    ...
    if(obj.event === 'detail'){
    	layer.open({
    		  ...
    		  shade: 0.8,
    		  area: ['700px', '500px'],
    		  content: 'http://localhost/design/server/recipesEdit.html?action=view&id='+obj.data.id
    		});
      ...
      layer.confirm('真的删除行么', function(index){
    	...
    	layer.open({
  		  ...
  		  shade: 0.8,
  		  area: ['700px', '500px'],
  		  content: 'http://localhost/design/server/recipesEdit.html?action=edit&id='+obj.data.id
  		});
    }
  });
});
